...
$wpmvc_app->router()->get('/example/{id:\d+}|/example/{id:\d+}/', 'ExampleController::single');
$wpmvc_app->router()->post('/example/', 'ExampleController::register');
$wpmvc_app->router()->put('/example/{id:\d+}|/example/{id:\d+}/', 'ExampleController::update');
$wpmvc_app->router()->delete('/example/{id:\d+}|/example/{id:\d+}/', 'ExampleController::delete');
